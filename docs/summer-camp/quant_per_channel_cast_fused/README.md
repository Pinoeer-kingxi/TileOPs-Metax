...
| 算子正确性测试 | `33 passed in 26.60s` |
| 固定基线正确性测试 | `7 passed in 23.53s` |
| Benchmark 基础测试 | `17 passed in 24.55s` |
| Ops Manifest 测试 | `7 passed in 22.88s` |
...
`smoke` 适合快速检查；`correctness` 执行全部 33 项生产测试；`baselines`
